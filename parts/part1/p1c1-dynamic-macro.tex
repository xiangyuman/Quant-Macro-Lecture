...
动态规划是量化宏观经济学的基础。本章借助现代宏观经济学的基石模型（Workhouse Model）——最优增长模型，对其进行介绍：
通过将原始的序列问题转化为递归形式问题，建立贝尔曼方程，进而引入确定性动态规划的基本理论方法；接着，对解的存在性和相应性质进行研究；
