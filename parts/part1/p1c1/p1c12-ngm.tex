...
对宏观经济发展过程中相关\textbf{特征事实}（Stylized Fact）的观察推动了现代宏观经济学的诞生。
自上世纪，美国经济的增长出现了一些显著特点：
（1）长期稳定的人均GDP\textbf{增速}；
（2）长期稳定的\textbf{资本产出比}；
（3）长期稳定的\textbf{资本租金率}；
（4）长期稳定的\textbf{劳动和资本份额}：其中资本层面，资本总量的增速稳定，租金率稳定；劳动层面，人均工时显著下降，而工资水平显著提高。

这些特点本身并不难以理解，例如从生产理论看，当要素的相对价格上升，厂商会减少这种要素的投入。
当工资上升，劳动相对资本的投入就减少，因此资本劳动比的增速与人均GDP增速接近，甚至略微高出。
但是索罗发现，如果将这些特征综合考虑，是难以同时解释的。例如，对于劳动的相对价格（工资）的提高，
一个自然的想法是技术进步，并且这一进步更多偏向劳动，从而单位时间劳动生产力提高，工资增加。
然而，在传统理论如哈罗德-多马模型下，他们将稳定的资本产出比视为前提条件，即资本与产出必须按固定比例结合（互补）。
但是，若二者是互补的话，工资上升的同时资本租金率也应当上升，这与事实不符。
