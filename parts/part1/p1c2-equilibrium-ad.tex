...
\begin{definition}
    \textbf{阿罗-德布鲁竞争均衡}（Arrow-Debreu Competitive Equilibrium），也可称阿罗-德布鲁均衡，
...
在这样的市场上，家庭、企业等经济主体将价格视为给定，最优化其目标函数，均衡时所有市场出清。\textbf{阿罗-德布鲁均衡其实是竞争均衡在一个完备市场下的实现形式}。
\begin{definition}
...
在\ref{subsubsec-ad-price}节，我们提出了理解竞争均衡价格的另一个视角：绕过价格系统，通过求解计划者问题来寻找阿罗-德布鲁均衡，
