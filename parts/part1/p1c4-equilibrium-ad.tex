...
% 3.1.2 ===== 两种交易结构（LS / Edmond / Kruger / PHS）
\subsection{两种交易结构}
...
\begin{figure}
    \includegraphics[width=1\textwidth]{figures/part1/p1c3-admarket-tree.png}
    \caption{两状态马尔科夫链的阿罗-德布鲁商品空间}
    \label{gr-admarket-tree}
\end{figure}
\begin{figure}
    \includegraphics[width=1\textwidth]{figures/part1/p1c3-sqmarket-tree.png}
    \caption{两状态马尔科夫链的阿罗-德布鲁商品空间}
...
% 3.3 =============== Kruger Decentralized Equilibrium Lafo ===============
\section{资本资产定价（CAPM）}
